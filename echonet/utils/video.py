...
def run(
   ...
   # if device.type == "cuda":
    ...
    ds = echonet.datasets.Echo(root=data_dir, split='val', **kwargs, clips="all")

    dataloader = torch.utils.data.DataLoader(
                    ds, batch_size=batch_size, num_workers=num_workers, shuffle=True, pin_memory=(device.type == "cuda"), drop_last=False)
    ...
    fig = plt.figure(figsize=(3, 3))
    plt.scatter(output.cpu().numpy, target.cpu().numpy, color="k", s=1, edgecolor=None, zorder=2)
    plt.show()
                #==============================================
...
if __name__ == '__main__':
    run(weights ='C:\\Users\\AII\\Documents\\dynamic\\output\\video\\r2plus1d_18_32_2_pretrained\\r2plus1d_18_32_2_pretrained.pt',data_dir='C:\\Users\\AII\\Documents\\dynamic\\a4c-video-dir')